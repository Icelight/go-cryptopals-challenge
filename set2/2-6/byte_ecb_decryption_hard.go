//This one is currently incomplete while I try to figure out a solution :)
package main
...
func main() {
    infilePtr := flag.String("in", "../files/2-6.dat", "Filename of file containing a base64'd string for use by enc. oracle")
    flag.Parse()
